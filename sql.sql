CREATE DATABASE  IF NOT EXISTS `words` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `words`;
...
INSERT INTO `dicionario` VALUES (1,'cat','gato',0),(2,'ball','bola',0),(3,'laranja','orange',NULL),(4,'red','vermelho',0),(5,'black','preta',0),(6,'blue','azul',0),(7,'green','verde',0),(8,'book','livro',0),(9,'pen','caneta',0),(10,'banana','banana',0);
...
-- Dump completed on 2018-03-30 17:44:30
